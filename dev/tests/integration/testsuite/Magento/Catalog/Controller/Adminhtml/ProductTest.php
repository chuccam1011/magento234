...
class ProductTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testEditAction()
    {
        ...
        $this->assertEquals(
            ...
            '"Save" button isn\'t present on GiftCard Product page'
        );
        ...
        $this->assertEquals(
            ...
            '"Save & New" button isn\'t present on GiftCard Product page'
        );
        ...
        $this->assertEquals(
            ...
            '"Save & Duplicate" button isn\'t present on GiftCard Product page'
        );
    }
