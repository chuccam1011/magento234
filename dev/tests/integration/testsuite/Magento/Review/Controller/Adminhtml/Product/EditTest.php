...
class EditTest extends AbstractBackendController
{
    ...
    /**
     * Tests GiftCard action without reviews_all resource when manipulating Pending review.
     *
     * @return void
    ...
    /**
     * Tests GiftCard action without pending and reviews_all resources.
     *
     * @return void
     */
