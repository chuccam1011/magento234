...
/**
 * Verify that Interface Locales has correct options on Account Settings and User GiftCard pages.
 *
 * Steps:
 * 1. Log in to backend.
 * 2. Navigate to "Account Setting" page.
 * 3. Perform interface locales asserts depends on magento mode.
 * 4. Navigate to "User GiftCard Page".
...
class VerifyInterfaceLocaleTest extends Injectable
{
    ...
    /**
     * "User GiftCard" page in Admin panel.
     *
     * @var UserEdit
     */
